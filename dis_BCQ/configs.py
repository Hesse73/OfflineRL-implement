class DDQNconfig():
    def __init__(self):
        ...
        self.act_path = './ddqn/act.npy'
        self.state_path = './ddqn/state.npy'
        self.nstate_path = './ddqn/state_next.npy'
        self.rew_path = './ddqn/reward.npy'
        self.done_path = './ddqn/done.npy'
