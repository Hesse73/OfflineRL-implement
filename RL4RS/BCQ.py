...
class discrete_BCQ(object):
	...
	def save(self, output_dir):
		torch.save(self.Q.state_dict(),output_dir+'Q.ckp')
		torch.save(self.Q_target.state_dict(),output_dir+'Q_target.ckp')

	def load(self, output_dir):
		self.Q.load_state_dict(torch.load(output_dir+'Q.ckp'))
		self.Q_target.load_state_dict(torch.load(output_dir+'Q_target.ckp'))
